...
在我个人看来，R语言当前所遇到的这些挑战对于有经验的程序员来说是一个很大的机会，他们大可以施展拳脚来推动R语言和R社区向更加成熟和完善的方向发展。R用户都很在乎写出高质量的代码，尤其是在做可重复性研究的时候，可是他们缺少相关的知识。我希望本书不仅能帮助更多的R用户提高能力成为高效的R程序员，同时也希望鼓励更多的其他编程语言领域的专业程序员来为R语言的发展做出贡献。
...
* 熟悉R的基本知识。理解复杂的数据类型并且知道处理这些数据类型相应的最佳方法。对R函数是如何运行的有更深入的理解，并且能够理解和使用R的四种面向对象体系。

* 理解什么是函数式编程，以及它为什么适合于数据分析。掌握如何快速地运用已有的工具，并且能�够开法你需要的新工具。

* 了解元编程的双刃剑特性。学习如何在规则范围内编写非标准评估的函数来简化代码，并且写出能处理复杂操作的华丽代码。明白运用元编程的风险，并且知道为什么要小心的使用元编程。

* 能对一些运行缓慢或耗用大量内存的R操作建立直觉的认知。知道如何剖析运行过程来准确定位代码中的瓶颈之处，并且学习一定的C++知识来将缓慢的R代码转换成快速的C++代码。

* 能够轻松的读懂大部分的R代码。学到R的一些常用术语（尽管你可能不会用到）并且能够赏析他人的代码。

##元技能

有两种对提高R程序员能力极其有用的元技能：**读源代码**和**科研的心态**。

读源代码很重要。因为它能帮助你写出更好的代码。发展这个技能最佳的方法是查看你常用的函数和工具包的源代码。你会发现一些值得在你的代码中模仿的技巧并且对好的代码培养欣赏能力。你也会发现一些不好的代码，比如代码的效率不明显，或则违反了你的直觉认识。然而阅读这些不好的代码也是有用的，它会帮助你修炼辨别好代码和坏代码的能力。

有一个科研的心态对学习R非常有帮助。如果你不明白一个东西是如何工作的，提出假设，设计一个实验，运行并且记录报告。这种练习是非常有用的。因为如果你不能够明白某个问题并且需要帮助，你能够很轻松的告诉别人你做了哪些尝试。同时当你理解正确答案的时候，你也会在潜意识里更新你的认知。当我仔细的向别人描述我的问题的时候（做可重复性[案例](http://stackoverflow.com/questions/5963269)的艺术），我经常在描述的过程中自己找到了问题的答案。

##推荐阅读

R仍然是一个比较年轻的语言，帮助你学习R的资源还在不断完善中。在我个人学习R的过程中，我发现其他编程语言相关的资源对于学习R特别有帮助。R语言同时拥有函数式编程和面向对象编程的特性。学习这些特性在R语言中的体现方式能帮助你巩固其他语言相关的知识，同时帮助你发现哪些地方你还有进步的空间。
...
当你在学习和运用R语言的过程中卡住或者找不出问题的原因的时候，目前有两种主要的获得帮助的途径：[stackoverflow](http://stackoverflow.com/)和R-help邮箱列表。这两种途径各具特色，两者你都能从中得到极有效的帮助。但是在提出问题前，最好你先了解一下各平台的背景和要求。
...
* 在提问前先搜索一下相关的问题。如果你能找到别人提出的同样的问题并且这个问题已经被解答了，那么使用已有的答案对你无疑是最快速的。


##致谢

我要谢谢R-help那些不厌其烦的贡献者以及[stackoverflow](http://stackoverflow.com/questions/tagged/r)。有很多需要感谢的不能一一列举，但是在这其中我要特别谢谢Luke Tierney，John Chambers，Dirk Eddelbuettel，JJ Allaire和Brian Ripley花费的宝贵时间来帮助更正我不计其数的理解错误。

这本书是完全开源完成的，每一章节都是在[twitter](https://twitter.com/hadleywickham)上公告后完成的。这本书是整个社区的成果：很多人参与草稿阅读，纠正拼写错误，提出修改建议，并且提供新的内容。没有这些帮助，这本书不会像现在这样完善，我由衷的感谢这些帮助。特别谢谢Peter Li，他一页一页的读过了整本书，并且纠正了很多的内容。其他特别贡献者包括Aaron Schumacher，@crtahlin，Lingbing Feng，@juancentro和 @johnbaums。
...
模板使用[jekyll](http://jekyllrb.com/)搭建, 并且用[travis-ci](https://travis-ci.org/)自动上传到Amazon的[S3](http://aws.amazon.com/s3/)
。本书完整版在[github](https://github.com/hadley/adv-r)
上开源。
